...
class EditExerciseForm extends Component {
 ...
 console.log(this.props.name)
    axios.get('http://localhost:8080/getWorkout/' + this.props.matchLink.match.params.name)
    .then(response => {
        this.setState({
            name: response.data.name,
            description: response.data.description,
            burnedCaloriesEasy: response.data.burnedCaloriesEasy,
            burnedCaloriesNormal: response.data.burnedCaloriesNormal,
            burnedCaloriesHard: response.data.burnedCaloriesHard
        })
    })
 }
...
handleSubmit = (e) => {
    ...
    return axios.post('http://localhost:8080/editExercise', data)
                .then(response=>{

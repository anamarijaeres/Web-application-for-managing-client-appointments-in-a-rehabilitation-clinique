...
class EditProduct extends Component{
    ...
    handleProductSubmit=(e)=>{
        ...
        return axios.put('http://localhost:8080/editProduct/' + name, data)
            .then(response=>{
    ...
    handleSaturatedFattyAcidsChange=(e)=>{
        this.setState({
            saturatedFattyAcids: e.target.value})
    }
                ...
                <div className="row">
                    <form onSubmit={this.handleProductSubmit}>
                        <div className="col s6 offset-s3">
                            <div></div>
                            <div className="container">
                                <select className="browser-default" value={this.state.value2} onChange={this.handleChange2}>
